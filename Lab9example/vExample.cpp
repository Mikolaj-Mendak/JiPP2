...
int main() {
    /**
     * na początku tworzymy przystanki z danymi id,name,dlugosc oraz szerokosc geograficzna.
     * zarezerwowalismy pamiec na ilosc 10 oraz vector<Stops> stops odnosi sie do klasy Stop, nazwa elementów stops
     */
    vector<Stop> stops;
    stops.reserve(14);
    ...
    /**
     * Następnie tworzymy elementy klasy Line. Tworzymy obiekt l1(linia pierwsza, następnie okreslamy numer i nazwe
     * na koncu dodajemy przystanki ktore zostaly poprzednio utworzone
     */
     ...
     * przy kompilacji programu mozna zauwazyc ze nazwy przystanków nie są wyświetlane
     * bledem byl rozmiar zarezerwowany dla vectora. Przekroczylismy wartosc 10 wiec nalezalo go zamienic na ilsoc 13
     * kolejnym bledem bylo nie dodanie przystanków do aktualnej linii
     */
